unit Crypt32;
//By Anatoly Podgoretsky. 32 bits encode/decode module.
//http://www.podgorestsky.com/
//http://torry.net/vcl/security/crypting/crypt32.zip
...
const
 StartKey = $696F6E; {Start default key}
 MultKey = 15644; {Mult default key}
 AddKey = 55891; {Add default key}
